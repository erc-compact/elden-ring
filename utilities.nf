...
READMEEOF
    ...
    # Copy generate_inputfile.sh script from pipeline directory
    cp "\${PROJECT_DIR}/generate_inputfile.sh" "\${BASEDIR}/generate_inputfile.sh"
    chmod +x "\${BASEDIR}/generate_inputfile.sh"
    echo "  ✓ Copied generate_inputfile.sh"

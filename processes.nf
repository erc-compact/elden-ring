...
process candypolice_pulsarx {
    ...
    container "${params.pulsarx_image}"
    publishDir "${params.candypolice.output_dir}/CP/Plots", pattern: "*.png", mode: 'copy'
    publishDir "${params.candypolice.output_dir}/CP/Archives", pattern: "*.{ar,cands}", mode: 'copy'

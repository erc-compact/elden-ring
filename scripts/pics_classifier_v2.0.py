...
def main(input_dir, pics_model_dir, output_file):
    ...
    logging.info("Scoring completed. Results saved to %s" % output_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output_file', help='Output file to save results', type=str)
    ...
    main(input_dir, pics_model_dir, output_file)
...
def main():
    ...
    with open(candfile, 'w') as cf, open(csvfile, 'w') as csvf, open(provfile, 'w') as pf:
        ...
        csvf.write("id,dm,period,f0,f1,f2,snr,sigma,sn_fft,acc,accel,z,w,period_ms,file,cand_num,accel_file\n")
        ...
        for k, cand in enumerate(cands, 1):
            ...
            csvf.write(f"{k},{cand.DM:.3f},{period_s:.12f},{f:.15f},{fd:.15e},{fdd:.15e},{snr_val:.2f},{cand.sigma:.2f},{sn_fft:.2f},{0.0:.6f},{0.0:.6f},{cand.z:.2f},{cand.w:.2f},{period_ms:.3f},{accel_base},{cand.candnum},{accel_base}\n")
